      ...
      <div class="row header-row">
        <div class="col-md-12 col-sm-12 col-xs-12 mt10 date-container ">
          ...
          <h1 class="title-text-route">
                        <span style="color: #6874ad;" class="hidden-xs hidden-sm">{{ trans('vexe.ticket_today')}}<i class="pl5 pr5 text-gray left-arrow"></i>
                    </h1>
              ...
              <div class="col-md-4 col-md-offset-0 col-xs-5 col-xs-offset-0 ">
                ...
                <div class="col-md-6 col-xs-12 ">
                  ...
                  <div class="pull-right ">
                    ...
                    <h4 class="seat-template-total-fare h4-text " id="sum-price">{{ $list->itinerary['ticket_fare']}}</h4><small class="unit-price-small ">{{ trans('vexe.money_ticket')}}</small>
                  </div>
                </div>
              </div>
