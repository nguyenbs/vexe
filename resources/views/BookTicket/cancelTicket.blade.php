...
<div class="check-ticket">
    <div class="container ">
        <div class="row">
            ...
            <div class="col-md-4 col-sm-9 col-xs-9 fill-info-ticket">
                <h4 class="text-check-ticket text-center bold">Nhập thông tin vé</h4>
                <form method="POST" action="{{ route('ticket.canceledTicket') }}">
                {{Form::token()}}
                    ...
                    @if($errors->has('g-recaptcha-response'))
                                    ...
                                    @endif   
                    <button type="submit" class="btn btn-check-ticket">Hủy Vé</button>
                </form>
            </div>
