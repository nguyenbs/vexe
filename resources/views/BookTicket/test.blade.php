                    ...
                    @foreach( $data as $key => $list)
                        <li class="news-item-content" style="list-style: none; border-bottom: 1px dashed #d5d5d5; padding-top: 30px; overflow: hidden;">
                            ...
                            <div class="col-md-2 col-sm-3 img_news" style="width: 166px">
                                <a class="img-content" href="{{-- {{route('news.show',$list->slug)}} --}}" title="{{ $list['name'] }}"> <img style="width: 100%">
                                </a>
                            </div>
                            <div class="col-md-9 col-sm-9 ">
                                <div class="title">
                                    <a class="news-tt" href="{{-- {{route('news.show',$list->slug)}} --}}" style="color: #6874ad; text-decoration: none; text-transform: uppercase;font-weight: bold;">{{ $list['name'] }} </a>
                                    <p> {!! $list['content'] !!}</p>
                                </div>
                                <!--End#title-->
