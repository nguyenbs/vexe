...
@section('contents')
   ...
   <div class="portlet-title">
      <div class="caption">
         <span class="caption-subject font-red bold uppercase"><i class="fa fa-plus-circle" aria-hidden="true"></i> SỬA </span>
      </div>
   </div>
   <h3 class="block text-center"><b>SỬA</b></h3>
                  ...
                  <div class="tab-pane active">
                     <div class="form-body col-xs-12 col-sm-12 col-md-8 col-md-offset-2 col-lg-10 col-lg-offset-1">
                        ...
                        <div class="form-group">
                          ...
                          <label for="images">Hình ảnh:</label><input type="file" name="images" value="" id="images" class=" borrowerImageFile" data-errormsg="PhotoUploadErrorMsg">
                                   
                          <img id="previewHolder" alt="" src="{{URL::asset('')}}{{$data->images}}" width="200px" height="150px"/>
                         </div> 
                         </div>  
                     </div>
                  </div>
